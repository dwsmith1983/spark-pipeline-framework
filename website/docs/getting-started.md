...
No resolver needed - artifacts are available on [Maven Central](https://central.sonatype.com/namespace/io.github.dwsmith1983).
...
- [Configuration](./configuration) - Learn about HOCON configuration options
- [Components](./components) - Build custom pipeline components
- [Lifecycle Hooks](./hooks) - Monitor and extend pipeline execution
